<div
    ...
    {{ $attributes->merge(['class' => 'theme-selector relative -mx-1.5 size-9 cursor-pointer select-none text-gray-900 hover:text-slate-600 dark:text-white dark:hover:text-[#bcc1ef]']) }}
    @click="toggle()"
    role="button"
