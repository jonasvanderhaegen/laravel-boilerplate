            ...
            <aside id="sidebar" class="hidden h-full w-80 shrink-0 border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 lg:block lg:rounded-lg">
                <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-800 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
                    ...
                    <div id="accordion-flush-body-1" class="mb-4 hidden space-y-4" aria-labelledby="accordion-flush-heading-1">
                        <div>
                            ...
                            <div class="relative block">
                                ...
                                <input type="search" id="search" class="block w-full rounded-lg border border-gray-300 bg-gray-50 px-4 py-2 ps-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="Search for categories" required />
                            </div>
                        </div>

                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input id="tv-audio-video" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="tv-audio-video" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> TV, Audio-Video </label>
                            </div>

                            <div class="flex items-center">
                                <input id="desktop-pc" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" checked />
                                <label for="desktop-pc" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Desktop PC </label>
                            </div>

                            <div class="flex items-center">
                                <input id="gaming" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="gaming" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Gaming </label>
                            </div>

                            <div class="flex items-center">
                                <input id="monitors" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="monitors" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Monitors </label>
                            </div>

                            <div class="flex items-center">
                                <input id="laptops" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" checked />
                                <label for="laptops" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Laptops </label>
                            </div>

                            <div class="flex items-center">
                                <input id="console" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="console" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Console </label>
                            </div>

                            <div class="flex items-center">
                                <input id="tablets" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" checked />
                                <label for="tablets" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Tablets </label>
                            </div>

                            <div class="flex items-center">
                                <input id="foto" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="foto" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Foto </label>
                            </div>

                            <div class="flex items-center">
                                <input id="fashion" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="fashion" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Fashion </label>
                            </div>

                            <div class="flex items-center">
                                <input id="books" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="books" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Books </label>
                            </div>
                        </div>

                        <a href="#" title="" class="inline-flex items-center gap-1 text-sm font-medium text-blue-700 hover:underline dark:text-blue-500">
                            See more
                    ...
                    <div id="accordion-flush-body-2" class="mb-4 hidden space-y-4" aria-labelledby="accordion-flush-heading-2">
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input id="rating-checkbox-1" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" checked />
                            ...
                            <div class="flex items-center">
                                <input id="rating-checkbox-2" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" checked />
                            ...
                            <div class="flex items-center">
                                <input id="rating-checkbox-3" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                            ...
                            <div class="flex items-center">
                                <input id="rating-checkbox-4" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                            ...
                            <div class="flex items-center">
                                <input id="rating-checkbox-5" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                    ...
                    <div id="accordion-flush-body-3" class="mb-4 hidden space-y-4" aria-labelledby="accordion-flush-heading-3">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="from_amount" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="300" required />
                            </div>

                            <div>
                                <label for="to_amount" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> To </label>
                                <input type="text" id="to_amount" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500" placeholder="3500" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="accordion-flush-body-5" class="mb-4 hidden space-y-4" aria-labelledby="accordion-flush-heading-5">
                        <div>
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                ...
                                <label class="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-blue-700 focus:outline-none has-[:checked]:ring-2">
                                    <input type="radio" name="color-choice" value="Blue" class="sr-only" />
                                    <span id="color-choice-0-label" class="sr-only"> Blue </span>
                                    <span aria-hidden="true" class="h-7 w-7 rounded-full border border-blue-700 border-opacity-10 bg-blue-700"></span>
                                </label>
                    ...
                    <div id="accordion-flush-body-6" class="mb-4 hidden space-y-4" aria-labelledby="accordion-flush-heading-6">
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input id="flowbox" type="radio" name="delivery" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="flowbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Flowbox </label>
                            </div>

                            <div class="flex items-center">
                                <input id="pick-from-store" type="radio" name="delivery" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="pick-from-store" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Pick up from the store </label>
                            </div>

                            <div class="flex items-center">
                                <input id="courier" type="radio" name="delivery" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                    ...
                    <div id="accordion-flush-body-7" class="mb-4 hidden space-y-4" aria-labelledby="accordion-flush-heading-7">
                        <div class="flex items-center">
                            <input id="new" type="radio" name="condition" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                            <label for="new" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> New Product</label>
                        </div>

                        <div class="flex items-center">
                            <input id="used" type="radio" name="condition" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                            <label for="used" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Used Prooduct</label>
                        </div>

                        <div class="flex items-center">
                            <input id="resealed" type="radio" name="condition" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                    ...
                    <div id="accordion-flush-body-8" class="my-4 hidden space-y-4" aria-labelledby="accordion-flush-heading-8">
                        <div class="space-y-3">
                            <div class="flex items-center">
                                <input id="weight-1" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="weight-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Under 1 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-2" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" checked />
                                <label for="weight-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 1 kg to 5 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-3" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="weight-3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 5 kg to 10 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-4" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="weight-4" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 10 kg to 20 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-5" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
            ...
            <div class="w-full">
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="sizes" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <select id="product-color-1" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="storage-size" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <select id="product-color-2" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="storage-size-2" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                        <option selected>512GB</option>
                                        <option value="1">1TB</option>
                                        <option value="2">2TB</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="product-color-3" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="storage-size-3" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                        <option selected>512GB</option>
                                ...
                                <div>
                                    ...
                                    <select id="product-color-4" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                        <option>Choose a color</option>
                                        <option value="GR">Gray</option>
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="storage-size-4" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                        <option selected>512GB</option>
                                        <option value="256">256GB</option>
                                        <option value="1">1TB</option>
                                        <option value="2">2TB</option>
                                ...
                                <div>
                                    ...
                                    <select id="product-color-5" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                        <option>Choose a color</option>
                                        <option value="GR">Gray</option>
                                        <option value="GD">Gold</option>
                                        <option value="Bk">Space Black</option>
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select id="storage-size-5" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                        <option selected>512GB</option>
                                        <option value="256">256GB</option>
                                        <option value="1">1TB</option>
                                        <option value="2">2TB</option>
                                ...
                                <div>
                                    ...
                                    <select id="product-color-6" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                                        <option>Choose a color</option>
                                        <option value="GR">Gray</option>
                                        <option value="GD">Gold</option>
                                        <option value="Bk">Space Black</option>
                ...
                <nav class="mt-6 flex items-center justify-center sm:mt-8" aria-label="Page navigation example">
                    <ul class="flex h-8 items-center -space-x-px text-sm">
                        ...
                        <li>
                            <a href="#" aria-current="page" class="z-10 flex h-8 items-center justify-center border border-blue-300 bg-blue-50 px-3 leading-tight text-blue-600 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:hover:bg-gray-700 dark:text-white">3</a>
                        </li>
                        <li>
            ...
            <div class="flex flex-1 flex-col justify-between">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="product-brand-2" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="w-full space-y-3">
                            ...
                            <div class="flex items-center">
                                <input id="flowbox-2" type="radio" name="delivery" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="flowbox-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Flowbox </label>
                            </div>

                            <div class="flex items-center">
                                <input id="pick-from-store-2" type="radio" name="delivery" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="pick-from-store-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Pick from the store </label>
                            </div>

                            <div class="flex items-center">
                                <input id="courier-2" type="radio" name="delivery" value="" class="h-4 w-4 border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="w-full space-y-3">
                            ...
                            <div class="flex items-center">
                                <input id="weight-6" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="weight-6" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Under 1 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-7" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" checked />
                                <label for="weight-7" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 1 kg to 5 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-8" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="weight-8" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 5 kg to 10 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-9" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
                                <label for="weight-9" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 10 kg to 20 kg </label>
                            </div>

                            <div class="flex items-center">
                                <input id="weight-10" type="checkbox" value="" class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600" />
